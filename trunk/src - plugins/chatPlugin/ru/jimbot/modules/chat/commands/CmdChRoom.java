 ...
 *
 */
public class CmdChRoom extends DefaultCommand {
    public CmdChRoom(Parser p) {
        super(p);
    }
 public Message m;
    /**
    ...
    public List<String> getCommandPatterns() {
        return Arrays.asList(new String[] {"!chroom","!измкомн"});
    }
   ...
   /**
    ...
    public String getHelp() {
        return " - <ид> <название> - изменить название комнаты";
    ...
    public String exec(String uin, Vector v) {
        ...
        Rooms r = cw.getRoom(room);
        r.setName(s);
        cw.saveRoom(r,"");
       return "Комната " + room + " успешно изменена!";
    }
