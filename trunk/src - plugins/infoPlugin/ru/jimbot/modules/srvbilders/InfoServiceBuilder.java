...
package ru.jimbot.modules.srvbilders;

import ru.jimbot.modules.info.*;
 ...
 *
 */
public class InfoServiceBuilder implements IServiceBuilder {

	
	public InfoService build(String name) {
    	return new InfoService(name);
