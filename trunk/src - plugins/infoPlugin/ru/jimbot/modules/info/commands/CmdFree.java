...
public class CmdFree extends DefaultCommand {
    ...
    public List<String> getCommandPatterns() {
        return Arrays.asList(new String[] {"!free","!своб"});
    }
    ...
    public String exec(String sn, Vector param) {
        String sn2 = ((InfoCommandParser)p).getFreeUin();
        ((InfoCommandParser)p).notify(new Message(sn2, sn, "Привет! Я самый свободный УИН ;)"));
